...
/* $siteroot points to the development folder.
   Empty string when deploying the live site. */
$siteroot = '';
?>
    ...
    <div id="header" role="banner">
        ...
        <div class="inner">
            ...
            <p id="offer">FREE SHIPPING* </p>
        </div>
    </div>

    <!--Drop Down Menu. No Navigation --> 
    <div id="nav_main" role="navigation" class="reset menu pull_out">
        <ul>
            <li> <a href="#" class="parent"><span>Arrangements</span></a>
                <div>
                    <ul>
            ...
            <li><a href="<?php echo $siteroot; ?>/bouquet.php"><span id='buildbouquet'>Build-a-Bouquet</span></a></li>
